...
const SECTIONS = {
  ...
  training: {
    ...
    description: 'Базовые термины и примеры для нового оператора.'
  },
  'kb-architecture': {
    title: 'Структура БЗ',
    description: 'Как разложить материалы по разделам и поддерживать порядок.'
  },
  about: {
    title: 'О примере',
    description: 'Что показывает этот набор материалов для первой линии поддержки.'
  }
};
...
const ARTICLES = [
  ...
  },
  {
    ...
    status: 'demo',
    lastReviewed: '2026-06-14',
    relatedArticles: ['wan-cable-check', 'l1-ticket-template', 'field-tech-request', 'network-admin-escalation'],
    body: `
      <h3>Цель</h3>
      ...
      <p>Уточните номер договора или адрес. Сверьте, что обращение относится к нужному подключению.</p>
      ...
      <p>Посмотрите историю отключений за последние 24–72 часа. Зафиксируйте частоту и время обрывов.</p>
      <h3>5. Проверка частых отключений порта</h3>
      <p>Если в карточке доступны события порта — проверьте, не пропадает ли линк несколько раз подряд. Это может указывать на кабель или порт.</p>
      ...
      <ul>
        ...
        <li>Результаты проверок: аварии, блокировка, отключения порта, соседи</li>
  ...
  {
    id: 'l1-ticket-template',
    section: 'checklists',
    title: 'Шаблон тикета L1',
    excerpt: 'Какие данные фиксировать перед закрытием, выездом или эскалацией.',
    tags: ['тикет', 'L1', 'эскалация', 'фиксация'],
    author: 'Синтетический материал',
    updated: '2026-06-14',
    readTime: '4 мин',
    audience: 'Оператор L1',
    ...
    status: 'demo',
    lastReviewed: '2026-06-14',
    relatedArticles: ['internet-drops-checklist', 'field-tech-request', 'network-admin-escalation'],
    body: `
      <p>Шаблон помогает передать обращение без потери контекста: что проверили, что ответил абонент и почему выбран следующий шаг.</p>
      <h3>Обязательные поля</h3>
      <ul>
        <li>Номер договора, адрес подключения или другой идентификатор абонента.</li>
        <li>Контактный телефон и удобный канал связи.</li>
        <li>Краткий симптом: что не работает и как часто повторяется.</li>
        <li>Когда началась проблема и что изменилось перед обращением.</li>
        <li>Где проявляется проблема: одно устройство или все; Wi‑Fi или кабель.</li>
      </ul>
      <h3>Что зафиксировать по диагностике</h3>
      <ul>
        <li>Проверены аварии, блокировка услуги и статус договора.</li>
        <li>Проверены кабель, WAN-порт, питание роутера и перезагрузка.</li>
        <li>Зафиксированы ответы абонента и действия, выполненные вместе с ним.</li>
        <li>Указан результат: помогло / не помогло / требуется выезд / требуется L2.</li>
      </ul>
      <h3>Когда использовать</h3>
      <ul>
        <li>Перед заявкой на техника.</li>
        <li>Перед передачей на сетевую группу или L2.</li>
        <li>Если обращение может вернуться повторно и важен контекст.</li>
      </ul>
      <h3>Короткая внутренняя заметка</h3>
      <p><code>Симптом: [кратко]. Проверено: [шаги]. Ответ абонента: [факты]. Результат: [итог]. Следующий шаг: [закрыто / выезд / L2].</code></p>
    `
  },
  {
    id: 'wan-cable-check',
    ...
    status: 'demo',
    lastReviewed: '2026-06-14',
    relatedArticles: ['tplink-pppoe', 'internet-drops-checklist', 'l1-ticket-template'],
    body: `
  ...
  },
  {
    ...
    status: 'demo',
    lastReviewed: '2026-06-14',
    relatedArticles: ['internet-drops-checklist', 'l1-ticket-template', 'wan-cable-check'],
    body: `
  ...
  },
  {
    ...
    status: 'demo',
    lastReviewed: '2026-06-14',
    relatedArticles: ['internet-drops-checklist', 'l1-ticket-template', 'field-tech-request'],
    body: `
      ...
      <ul>
        ...
        <li>Нужна проверка логов на стороне сетевого оборудования</li>
      </ul>
  ...
  },
  {
    ...
    body: `
      ...
      <ol>
        ...
        <li>Открыть карточку абонента</li>
  ...
  },
  {
    ...
    title: 'Как разложить материалы в базе знаний',
    excerpt: 'Пример простой структуры: клиентские инструкции, чек-листы, макросы, эскалации и обучение.',
    tags: ['структура', 'база знаний', 'обучение', 'L1'],
    author: 'Синтетический материал',
    updated: '2026-06-14',
    readTime: '5 мин',
    audience: 'Оператор L1 / Технический писатель',
    type: 'Структура БЗ',
    status: 'demo',
    lastReviewed: '2026-06-14',
    relatedArticles: ['before-after-rewrite', 'wan-lan-pppoe-basics'],
    body: `
      <h3>Зачем нужна структура</h3>
      <p>База знаний должна помогать оператору быстро найти нужный материал: что отправить клиенту, что проверить самому и когда передать обращение дальше.</p>
      <h3>Для кого материалы</h3>
      <ul>
        <li><strong>Клиент</strong> — короткие инструкции без внутреннего жаргона.</li>
        <li><strong>Оператор L1</strong> — чек-листы, макросы и правила эскалации.</li>
        <li><strong>Новичок</strong> — базовые термины и типовые сценарии.</li>
      </ul>
      <h3>Разделы базы знаний</h3>
      <ul>
        <li>Клиентские инструкции — что можно отправить абоненту.</li>
        <li>Внутренние чек-листы L1 — что проверяет оператор.</li>
        <li>Макросы — готовые формулировки для чата и тикета.</li>
        <li>Эскалации — когда нужна вторая линия или техник.</li>
        <li>Обучение новичка — термины и типовые ситуации.</li>
      </ul>
      <h3>Как поддерживать порядок</h3>
      <ul>
        <li>Не смешивать клиентский текст и внутреннюю диагностику в одной статье.</li>
        <li>Давать статье понятный заголовок: «Как настроить…», «Когда передавать…», «Проверка…».</li>
        <li>Добавлять связанные материалы: инструкция, чек-лист, макрос или правило эскалации.</li>
        <li>Пересматривать статьи после изменений в процессе поддержки.</li>
      </ul>
      <h3>Проверка качества</h3>
      <ul>
        <li>Понятно, кто читатель: клиент, оператор или новичок.</li>
        <li>Шаги короткие и идут в рабочем порядке.</li>
        <li>В клиентской инструкции нет внутренних терминов.</li>
        <li>Есть следующий шаг, если инструкция не помогла.</li>
      </ul>
    `
  },
  {
    ...
    section: 'training',
    title: 'Пример редакторской правки',
    excerpt: 'Как упростить клиентскую инструкцию и убрать лишний внутренний жаргон.',
    tags: ['редактура', 'клиент', 'обучение'],
    author: 'Синтетический материал',
    updated: '2026-06-14',
    readTime: '6 мин',
    audience: 'Технический писатель / Оператор L1',
    type: 'Обучающий пример',
    status: 'demo',
    lastReviewed: '2026-06-14',
    relatedArticles: ['tplink-pppoe', 'kb-structure'],
    body: `
      <p>Ниже — типичные проблемы клиентских инструкций и варианты более понятной формулировки.</p>
      <table class="compare-table">
        ...
        <tbody>
          <tr>
            <td>«Зайдите в веб-интерфейс роутера, проверьте WAN/LAN, выберите PPPoE, внесите учётные данные и при необходимости проверьте индикацию. Если не работает — уточните настройки у провайдера»</td>
            <td>Разбить на короткие шаги: открыть адрес роутера, выбрать PPPoE, ввести логин и пароль, сохранить настройки, проверить сайт</td>
            <td>Абонент выполняет по одному действию за раз; меньше шансов потеряться</td>
          </tr>
          <tr>
          ...
          <tr>
            <td>«Проверьте LOS/PON на ONT и события порта в системе»</td>
...
const MACROS = [
  ...
  },
  {
    ...
    text: '[Внутренняя заметка для тикета] Диагностика L1 завершена. Требуется проверка на стороне сетевого оборудования: [описать симптом, отключения порта, обращения соседей]. Карточка абонента: [ID]. Действия с клиентом: [список].'
  },
  {
  ...
  },
  {
    ...
    text: 'Обращение зафиксировано. Если проблема повторится или появятся новые симптомы — напишите нам снова и укажите номер обращения. Мы продолжим проверку по сохранённым данным.'
  }
];
...
/** HTML краткой информации для карточки */
...
function renderAbout() {
  return (
    '<div class="article-view">' +
    '<div class="article-body">' +
    '<p>Это демонстрационный пример базы знаний для первой линии поддержки. Сайт нужен только как удобная оболочка для просмотра материалов.</p>' +
    '<h3>Что показывает пример</h3>' +
    '<ul class="about-list">' +
    '<li>Как отделять текст для клиента от внутренней инструкции для оператора.</li>' +
    '<li>Как собирать короткие клиентские инструкции.</li>' +
    '<li>Как строить чек-листы диагностики для L1.</li>' +
    '<li>Как оформлять макросы для чата и тикета.</li>' +
    '<li>Как описывать условия эскалации.</li>' +
    '</ul>' +
    '<h3>Моя роль</h3>' +
    '<p>Я продумал структуру базы знаний, разделил материалы по аудиториям, написал инструкции, чек-листы, макросы и правила эскалации.</p>' +
    '<p>Все примеры синтетические и не содержат реальных клиентских данных.</p>' +
    '</div>' +
    '</div>'
  );
}
